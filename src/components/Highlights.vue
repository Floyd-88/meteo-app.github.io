...
import {mm} from '../constants/constants.js'
import {getTimeMM} from '../utils/index.js'
...
const pressure = computed(() => {
    return Math.round(props.weatherData?.main?.pressure * mm);
})

const sunrise = computed(() => {
    let sec = props.weatherData?.sys?.sunrise + props.weatherData?.timezone;
    return getTimeMM(sec)
})

const sunset = computed(() => {
    let sec = props.weatherData?.sys?.sunset + props.weatherData?.timezone;
    return getTimeMM(sec)
})
</script>
            ...
            <div class="highlight">
                ...
                <div class="card-small">
                    ...
                    <div class="card-small-info">
                        <div class="card-small-data" v-if="weatherData?.wind?.gust">
                            <div class="info-main-num">
